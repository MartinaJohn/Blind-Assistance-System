...
# PATH_TO_LABELS = 'C:/Users/Martina/Machine Learning - Jupyter/Blind Assistance1/models/research/object_detection/data/mscoco_label_map.pbtxt'

# get the current directory of the Python script
SCRIPT_DIR = os.path.dirname(os.path.abspath(__file__))

# construct the path to the label map file relative to the script directory
            ...
            if scores[0][i] >= 0.5:
                ...
                if apx_distance <= 0.1:
                    if mid_x > 0.3 and mid_x < 0.7:
                        ...
                        print("Warning -Object very close to the frame")
                        engine.say("Warning -Object very close to the frame")
                        engine.runAndWait()
                else:
                    if mid_x > 0.3 and mid_x < 0.7:
                        cv2.putText(image_np, 'SAFE!!!', (50,50), cv2.FONT_HERSHEY_SIMPLEX, 1.0, (0,255,0), 3)
                        print("-Object at safer distance from the frame")
                        engine.say("Object is AT A SAFER DISTANCE")
                        engine.runAndWait()
